...
#ifndef _DS1683_ETC_H    /* Guard against multiple inclusion */
#define _DS1683_ETC_H
...
void DS1683ETCInitialize(uint8_t device_address, volatile uint8_t *device_error_handler_flag);
